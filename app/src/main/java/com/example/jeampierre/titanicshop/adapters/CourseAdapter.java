package com.example.jeampierre.titanicshop.adapters;
...
import com.example.jeampierre.titanicshop.activities.DetailActivity;
...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHolder>
    ...
    private List<ProductoPojo> items;


    public CourseAdapter(Context context, List<ProductoPojo> items) {
    ...
    public void onBindViewHolder(CourseViewHolder viewHolder, int i) {
        ...
        ProductoPojo currentItem = items.get(i);
        ...
        viewHolder.students.setText(currentItem.getStudents() + " Compras");
        // Cargar imagen
        Glide.with(context)
